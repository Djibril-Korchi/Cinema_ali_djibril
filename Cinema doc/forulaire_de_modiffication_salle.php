<form method="post" action="Modifier.php">
    <table>
        ...
        $reponse = $bdd->prepare('SELECT * FROM sallecinema WHERE id_salle = :id');
        ...
        foreach ($donne as $element) {
            echo "
                ...
                <tr><td>Le Film diffusé dans la salle :</td><td><input type='text' name='ref_film' value=" . $element[''] . "></td></tr>
